...
public class EscalasanElian extends AppCompatActivity {
   ...
   // Button btnfalanges, btnmetatarsiano, btntarsal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // btnfalanges=findViewById(R.id.btnfalange);
        ...
        areacv2= bundle.getString(areaCV);
        double areatemp = Double.parseDouble(areacv2);
        int areaCV3 = (int) Math.round(areatemp);


        if (areaCV3 <= 100){
            area = 1;
        }
        if (areaCV3 > 101 || areaCV3 <= 400){
            area = 2;
        }
        if (areaCV3 >401){
            area = 3;
  ...
  /*
    ...
    public void guardardatos(View view) {
        ...
        String ctime = currentDateandTime;
        ...
        load2.get().addOnSuccessListener(documentSnapshot -> {
                ...
                if(Objects.equals(ctime, TRuta6)){
                Nruta1 = TRuta1;
                Nruta2 = TRuta2;
                Nruta3 = TRuta3;
                Nruta4 = TRuta4;
