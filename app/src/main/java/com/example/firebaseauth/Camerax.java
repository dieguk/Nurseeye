...
public class Camerax extends AppCompatActivity {
    ...
    public void sacarfoto(View view) {
        ...
        //File fotodir = new File("mnt/sdcard/Pictures/CameraXphotos");
        //File fotodir = new File("/storage/14EF-3A15/Pictures");
        //File fotodir = getExternalFilesDir("/storage/14EF-3A15/Pictures");
